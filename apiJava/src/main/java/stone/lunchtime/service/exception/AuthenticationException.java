...
/**
 * Authenticatione exception
 */
public class AuthenticationException extends AbstractFunctionalException {
	 ...
	 */
	public AuthenticationException(String pMessage) {
		super(pMessage);
	}
	 ...
	 * @since 1.4
	 */
	public AuthenticationException(Throwable pCause) {
		super(pCause);
	}
	 ...
	 * @since 1.4
	 */
	public AuthenticationException(String pMessage, Throwable pCause) {
